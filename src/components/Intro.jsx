...
const Intro = () => {
  ...
  return (
    <div className='intro'>
      <h3>Intro</h3>
      <p className=""><img src='https://a.slack-edge.com/production-standard-emoji-assets/14.0/google-large/1f30c.png'/> Lives in<span className="location">{clickedProfile.location.name} {clickedProfile.origin.name !== "unknown" && clickedProfile.origin.name}</span></p>
